...
public:
	...
	virtual std::string GetOutputDirectory() const
	{
		...
		{
			pkgName1  = "com.tencent.ig";
		}
		else if (isapkrunning("com.vng.pubgmobile"))
		{
			pkgName1  = "com.vng.pubgmobile";

		}
		else if (isapkrunning("com.pubg.krmobile"))
		{
			pkgName1  = "com.pubg.krmobile";
		}
		else if (isapkrunning("com.rekoo.pubgm"))
		{
			pkgName1  = "com.rekoo.pubgm";
		}
		else if (isapkrunning("com.pubg.imobile"))
		{
			pkgName1  = "com.pubg.imobile";
		}
		else if (isapkrunning("com.tencent.igce"))
		{
			pkgName1  = "com.tencent.igce";
		}
		else
		{
			pkgName1  = "Cheatbot";
		}
		//std::string pkgName1 = "com.pubg.imobile";
		std::string Media_Folder1 = "/storage/emulated/0/Android/media/" + pkgName1;
		return Media_Folder1;
	}
