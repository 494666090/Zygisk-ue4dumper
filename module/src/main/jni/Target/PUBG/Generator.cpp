...
public:
	bool Initialize() override
	{
		...
		virtualFunctionPattern["Class CoreUObject.Object"] = {
				{ "\x45\x33\xF6\x4D\x8B\xE0", "xxxxxx", 75, R"(	inline void ProcessEvent(class UFunction* function, void* parms)
	{
		...
		virtualFunctionPattern["Class CoreUObject.Class"] = {
				{ "\x4C\x8B\xDC\x57\x48\x81\xEC", "xxxxxxx", 112, R"(	inline UObject* GetDefaultObject(bool bCreateIfNeeded = true)
	{
		return static_cast<UObject*>(GetVFunction<UObject*(*)(UClass*, bool)>(this, %d)(this, bCreateIfNeeded));
	})" }
		};
	...
	{ })"),
				...
				PredefinedMethod::Inline(R"(	static float Distance(const FVector2D& a, const FVector2D& PE_Result)
	{
				...
				PredefinedMethod::Default("bool IsA(UClass* cmp) const", R"(bool UObject::IsA(UClass* cmp) const
{
	...
	return false;
		...
		predefinedMethods["Class CoreUObject.Class"] = {
				PredefinedMethod::Inline(R"(	inline UObject* GetDefaultObject(bool bCreateIfNeeded = true)
	{
		return GetVFunction<UObject* (*)(UClass*, bool)>(this, 112)(this, bCreateIfNeeded);
	})")
		};
	...
	{
		return  "PlayerUnKnowns BattleGrounds Mobile";
	}
